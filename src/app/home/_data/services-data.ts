      ...
      options: [
        {
          ...
          price: '89K',
          steps: [
            'Khai thông kinh huyệt đầu',
            'Tẩy trang',
            'Rửa mặt',
            'Massage mặt',
            'Gội dưỡng sinh (2 lần)',
            'Ủ tóc kết hợp massage da đầu',
            'Massage cổ - vai - gáy',
            'Xả tóc & massage cổ vai gáy (ngồi)',
            'Sấy tóc & dưỡng tóc',
          ],
        },
        {
          ...
          steps: [
            ...
            'Rửa mặt',
            'Massage mặt',
            'Đắp mặt nạ bột thiên nhiên',
            'Tẩy tế bào chết da đầu',
            'Gội dưỡng sinh (2 lần)',
            'Ủ tóc kết hợp massage da đầu',
            'Massage cổ - vai - gáy kết hợp đá nóng',
            'Chườm khăn thảo mộc nóng',
            'Xả tóc & massage cổ vai gáy (ngồi)',
            'Sấy tóc & xịt dưỡng tóc',
          ],
        },
        {
          id: 'intensive',
          ...
          steps: [
            ...
            'Tẩy tế bào chết da mặt',
            'Rửa mặt',
            'Massage mặt chuyên sâu kết hợp ấn huyệt',
            'Tẩy tế bào chết da đầu',
            'Gội dưỡng sinh (2 lần)',
            'Gội thảo mộc',
            'Ủ tóc kết hợp massage da đầu chuyên sâu',
            'Massage cổ - vai - gáy & tay kết hợp đá nóng',
            'Chườm khăn thảo mộc nóng',
            'Xả tóc & massage cổ vai gáy (ngồi)',
            'Sấy tóc & dưỡng tóc',
          ],
      ...
      options: [
        {
          ...
          price: '89K',
          steps: [
            'Scalp Meridian Therapy',
            'Makeup Removal',
            'Facial Cleansing',
            'Facial Massage',
            'Therapeutic Hair Wash (Twice)',
            'Hair Conditioning with Scalp Massage',
            'Neck & Shoulder Massage',
            'Hair Rinse & Seated Neck Massage',
        ...
        },
        {
          ...
          steps: [
            ...
            'Hair Rinse & Seated Neck Massage',
            'Professional Blow Dry & Hair Serum',
          ],
        },
        {
          id: 'intensive',
          ...
          steps: [
            ...
            'Facial Exfoliation',
            'Facial Cleansing',
            'Deep Facial Massage with Crystal Acupressure',
            'Scalp Exfoliation',
            'Therapeutic Hair Wash (Twice)',
            'Herbal Hair Wash',
            'Deep Hair Conditioning with Scalp Massage',
            'Hot Stone Neck, Shoulder & Arm Massage',
            'Hot Herbal Towel Compress',
            'Hair Rinse & Seated Neck Massage',
            'Professional Blow Dry & Hair Care',
          ],
        },
      ],
    },
